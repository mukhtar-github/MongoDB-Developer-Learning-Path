...
Here, you can learn a bunch of interesting information about your collection. For example, if the *_id* feild value has the type *ObjectId*, then it stores the information about when this document was created. In this case, all the documents from this sample of data were created on a *Wednesday in January of 2014. The next feild is *acquisition*. At a high level, we see that most documents have the value *null* in the feild. But approximately
